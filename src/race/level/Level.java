...
public class Level {
	...
	public Level(Map map, ArrayList<Obstacle> obstacles, GameLocation spawn1, GameLocation spawn2, GameLocation goal) {
		...
		this.playerSpawn1 = spawn1;
		this.playerSpawn2 = spawn2;
		this.goal = goal;
	...
	public GameLocation getPlayerSpawn1() { return playerSpawn1; }
	public GameLocation getPlayerSpawn2() { return playerSpawn2; }
	public GameLocation getGoal() { return goal; }

	public void setPlayerSpawn1(GameLocation sp) { this.playerSpawn1 = sp; }
	public void setPlayerSpawn2(GameLocation sp) { this.playerSpawn2 = sp; }
	public void setGoal(GameLocation goal) { this.goal = goal; }
	...
	public Terrain getTerrainAt(double x, double y) {
		int row = (int) (y / Game.GAME_SCALE),
			col = (int) (x / Game.GAME_SCALE);

		return map.getTile(row, col).getTerrain((int) x % Game.GAME_SCALE,
												(int) y % Game.GAME_SCALE);
	}
	...
	public boolean isExportable() {
		return map != null && obstacles != null && playerSpawn1 != null &&
			   playerSpawn2 != null && goal != null;
	}
	...
	public static Level load(String path) throws IOException, ParseException {
		...
		try {
			...
			if (!identifier.equals("MAP")) throw new ParseException("Not a recognized map", 0);
			...
			GameLocation sp1 = GameLocation.deserialize(s.nextLine()),
					   	 sp2 = GameLocation.deserialize(s.nextLine()),
